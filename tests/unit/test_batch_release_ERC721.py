...
def test_batch_release_ERC721_releasable_false(extend_release_time, willer_contract, executor, testator, ERC721_token_contracts, n_ids):
...
def test_batch_release_ERC721_releasable_true(wait_release_time, willer_contract, executor, testator, ERC721_token_contracts, n_ids):
    expected = {}
