...
def test_batch_release_ERC20_releasable_false(add_will, extend_release_time, willer_contract, testator, executor, ERC20_token_contracts):
...
def test_batch_release_ERC20_releasable_true(add_will, wait_release_time, willer_contract, testator, executor, ERC20_token_contracts):
