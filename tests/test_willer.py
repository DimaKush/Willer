...
#         with brownie.reverts():
#             willer_contract.releaseERC1155(testator, ERC1155_token_contract, list(range(n_ids)), [value] * n_ids,  {'from': executor})
...
#             for index, beneficiary in beneficiaries:            
#                 assert ERC1155_token_contract.balanceOf(beneficiary, id) == value * shares[index] / sum(shares)
